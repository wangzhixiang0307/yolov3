...
#vid=cv2.VideoCapture("http://wangzhixiang:wzx19930307@192.168.8.237:8080/video")
...
with tf.Session() as sess:
    ...
    while True:
        ...
        cv2.imshow('image', cv2.resize(img_ori, (height, width),interpolation=cv2.INTER_CUBIC))
        if args.save_video:
